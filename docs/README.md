...
| [`PRIORITY-PATH-agentic-lab.md`](PRIORITY-PATH-agentic-lab.md) | The specification for the `agentic-lab` deck: which 179 `it-vocab` sentences it re-uses, in which of the five phases, and why that order. |
